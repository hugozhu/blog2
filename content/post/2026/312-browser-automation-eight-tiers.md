---
title: "Agent 操作浏览器的八条路线：从 Playwright 到 Computer Use"
subtitle: "Eight Tiers of Browser Automation for AI Agents — and the Layered Architecture That Actually Works"
date: 2026-07-26
...
Browser Automation 在 AI Agent 语境下，已经不是一道单选题。它是一张技术地图，八个梯队，各有适用场景。而真正在生产环境里跑通的企业 Agent，几乎都是 **分层架构**——API 优先，结构化浏览器控制居中，Vision 兜底。
...
在展开八个梯队之前，先说清楚筛选标准。不是所有浏览器自动化技术都适合 Agent 场景。我的三条硬约束：
...
**优先 API**——能用 API 解决的事，绝不开浏览器。API 是最快、最稳定、最便宜的路径。
