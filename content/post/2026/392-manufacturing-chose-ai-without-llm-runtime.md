...
这个反驳的前半段是对的——资产沉淀不是 AI 时代的新发明。但降价降到某个刻度，会引起质变。过去内部工具是「定制开发」：单个需求几万元起、排期以月计，企业一年做不了几个，资产复用价值根本摊不平维护成本，所以理性选择是不做，让 Excel 和人工沟通凑合——文章说的「最后一公里」长期空着，不是没人看见，是经济上不划算。AI Coding 把单个工具的成本压到人天级之后，工具密度会上一个数量级；密度够高，接口和规则的复用才开始产生正收益，「留下资产」才从最佳实践变成经济必然。这正是 [软件工厂 3.0](https://hugozhu.site/post/2026/356-software-factory-3-0-selling-molds/) 里模具的逻辑：模具值钱的前提是有足够多的订单来摊销它。
