...
AI 的代码执行速度是人的 50-100 倍。但它不知道「取消应该丢弃修改」这种产品常识。把它当作一个执行力极强、理解力中等的初级工程师——你说得越清楚，它做得越好；你说得越模糊，它越容易「正确地做错事」。
...
|------|------|
| 总 commit 数 | 35 |
| 代码行数 | 6,773（不含 node_modules） |
| JS 文件数 | 13 |
| 技术栈 | Vanilla JS + Supabase + Yjs + CodeMirror |
| 构建步骤 | 零（无框架、无打包） |
| 密集开发期 | 6 月 9-10 日，2 天 |
| 6 月 10 日 commit 数 | 15 |
| 自动化测试 | 8 个，全部通过 |
| AI 模型 | Hermes Agent（多模型路由） |
| 人写的代码行数 | 0 |
