...
「如果不能」悬在半空。我当时的回答很直接： **钉钉做的是让 AI 能进入企业组织架构的基建——数字员工账号、连接多 Agent，权限管控、运行审计、知识管理，为任务提供上下文等基础能力，还提供入转调离全生命周期管理、执行前主管审批确认放行、岗位能力评测、拟人化交互考核等功能，但还不能对企业自建或生态交付的数字员工的产出效果负责。**
...
- **岗位能力评测**：上岗前和上岗后都要评——它到底能不能胜任这个岗位；
- **拟人化交互考核**：它是对话里的一个「同事」，沟通质量本身也要被考核。
